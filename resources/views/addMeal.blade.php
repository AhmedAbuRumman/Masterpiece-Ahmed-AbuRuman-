...
<body>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="section-title text-center clearfix">
                            <div class="title-header">
                                <h5>تتبع برنامجك الغذائي معنا</h5>
                ...
                <div class="container">
                    ...
                    <div class="row tab-row">
                        <div class="col-md-12">
                            ...
                            <ul class="tabs">
                                <li class="tab active"><a href="#"><i class="fa fa-gift"></i><span>Monday</span></a></li>
                                <li class="tab"><a href="#"><i class="fa fa-gift"></i><span>Tuesday</span></a></li>
                                <li class="tab"><a href="#"><i class="fa fa-gift"></i><span>Wednesday</span></a></li>
                                <li class="tab"><a href="#"><i class="fa fa-gift"></i><span>Thrusday</span></a></li>
                                <li class="tab"><a href="#"><i class="fa fa-gift"></i><span>Friday</span></a></li>
                                <li class="tab"><a href="#"><i class="fa fa-gift"></i><span>Saturday</span></a></li>
                            </ul>
                    ...
                    <p>Date: <input type="text" name="datepiker" id="datepicker"></p>
                                ...
                                <table class="shop_table shop_table_responsive">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="product-remove"> السعرات الحرارية</th>
                                            <th class="product-remove">الكربوهيدرات</th>
                                            <th class="product-remove">البروتينات</th>
                                            <th class="product-remove">الدهون</th>
                                            <th class="product-remove">السكر</th>
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th class="product-remove">وجبة الإفطار</th>
                                        </tr>
                                        <tr>
                                            <th class="product-remove">بيضة</th>
                                            <th class="product-remove">78</th>
                                            <th class="product-remove">2</th>

                                        </tr>
                                        <tr>
                                            <th>
                                                <a class="ttm-btn ttm-btn-size-sm ttm-btn-shape-round ttm-btn-style-fill ttm-icon-btn-right ttm-btn-bgcolor-skincolor" href="#" title="">إدخل الوجبة <i class="ti ti-arrow-circle-right"></i></a>
                                            </th>
                                        </tr>
                                        <tr>
                                            <th class="product-remove">وجبة الغداء</th>
                                        </tr>
                                        <tr>
                                            <th>
                                                <a class="ttm-btn ttm-btn-size-sm ttm-btn-shape-round ttm-btn-style-fill ttm-icon-btn-right ttm-btn-bgcolor-skincolor" href="#" title="">إدخل الوجبة <i class="ti ti-arrow-circle-right"></i></a>
                                        ...
                                        <tr>
                                            <th class="product-remove">وجبة العشاء</th>
                                        </tr>
                                        <tr>
                                            <th>
                                                <a class="ttm-btn ttm-btn-size-sm ttm-btn-shape-round ttm-btn-style-fill ttm-icon-btn-right ttm-btn-bgcolor-skincolor" href="#" title="">إدخل الوجبة <i class="ti ti-arrow-circle-right"></i></a>
                                        ...
                                        <tr>
                                            <th class="product-remove">وجبة خفيفة</th>
                                        </tr>
                                        <tr>
                                            <th>
                                                <a class="ttm-btn ttm-btn-size-sm ttm-btn-shape-round ttm-btn-style-fill ttm-icon-btn-right ttm-btn-bgcolor-skincolor" href="#" title="">إدخل الوجبة <i class="ti ti-arrow-circle-right"></i></a>
                            ...
                            <div class="row-title">
                                ...
                                <div class="section-title clearfix">
                                    ...
                                    <div class="title-desc">
                                        <p>It is my mission and passion to help you achieve a life of vibrant health and wellbeing!</p>
                                    </div>
                                </div>
    ...
    <script src="public_theme/js/main.js"></script>
    ...
    <script>
        let userData = {};
        const datepikerInput = $("#datepicker");

        userData.date = datepikerInput.val();
